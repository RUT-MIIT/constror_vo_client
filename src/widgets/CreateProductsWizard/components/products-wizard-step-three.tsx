				...
				<Form name='create-products-wizard-step-3' onSubmit={handleSubmit}>
					<FormField title='Создание нормативно-справочной информации для продуктов'>
						<Field
							...
							На следующем шаге - сохраните, если результат соответствует Вашим ожиданиям. В дальнейшем Вы сможете его редактировать. Перегенерируйте, если хотите получить другую версию источников НСИ. '
						/>
					</FormField>
				</Form>
			</WizardMain>
