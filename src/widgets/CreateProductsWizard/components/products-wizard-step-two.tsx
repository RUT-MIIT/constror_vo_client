...
export const ProductsWizardStepTwo: FC<IProductsWizardStepTwoProps> = ({
	...
	return (
		<>
			<WizardMain>
				<WizardSubtitle text='Конструктор проанализировал замысел образовательной программы и предложил описание продуктов, в создании которых участвует выпускник образовательной программы. Сохраните, если результат соответствует Вашим ожиданиям. В дальнейшем Вы сможете его редактировать. Перегенерируйте, если хотите получить другую версию описания продуктов. Вернитесь назад, чтобы скорректировать замысел образовательной программы.' />
